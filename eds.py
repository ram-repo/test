...
def getSQSMessage():
    ...
    assetRestaurantIdResponseJson = json.loads(assetRestaurantIdResponse.text)
...
def confirmCertificateDelivery(k8sName, assetsUrl, assetRestaurantId):
    ...
    propertyResponseJson = json.loads(propertyResponse.text)
...
def configure():
    ...
    assetsUrlResponseJson = json.loads(assetRestaurantIdResponse.text)
